...
public class CustomerRepositoryFixtures {
    ...
    public static InMemoryTestCustomerRepository preExistingCustomerInMemoryRepositoryFixture(BidRangePredicateFactory factory, Customer... customers) {
        ...
        return new InMemoryTestCustomerRepository(factory, customerStorage);
    }
